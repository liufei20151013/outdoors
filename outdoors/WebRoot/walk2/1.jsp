...
<body>
  ...
  <div class="con">
    <h1 >&nbsp;</h1>
    <h1 >法国 écrins 艾勒弗鲁瓦德</h1>
    <p >&nbsp;</p>
          <h1 ><img src="images/py1.jpg" width="600" height="394"></h1>
          <p >&nbsp;</p>
          <p >           您已经能够完成单线运动攀登，想尝试更远更冒险的路线吗？一处位于法国阿尔卑斯山écrins地区艾勒弗鲁瓦德下游，峰值为4000米的山面可能正是您理想的攀岩墙。这处坐落于阿尔卑斯山谷中的山面上有十几条较易攀登的路线，主要是直行路线，并有固定点作保护，能够让您很好的练习多段攀登（路线通常长于50米）。初试多段攀岩的运动者最好在佩尔武附近的指导局（Bureau des Guides）获得教练的指导。 </p>
