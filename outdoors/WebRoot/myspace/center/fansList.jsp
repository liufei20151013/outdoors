...
<script type="text/javascript" src="js/center/fanceList.js"></script>
<!-- 
<script src="${pageContext.request.contextPath}/article/addArticleImage/js/jquery.min.js"></script>
 -->
<style type="text/css">
...
<script type="text/javascript">
    function gotopage(currentpage){
    	location = "${pageContext.request.contextPath}/space.do?method=fanceList&currentpage=" + currentpage+"&userId=${userId}";
