...
<body>
  ...
  <div class="con">
    ...
    <h1 >法国枫丹白露</h1>
    <p >&nbsp;</p>
          <h1 ><img src="images/py5.jpg" width="600" height="360"></h1>
          <p >&nbsp;</p>
          <p >           作为攀登的一种，抱石的概念源于20世纪60年代，由一群法国攀岩者根据巴黎南部枫丹白露森林中的巨石发明。其中一位名叫皮埃尔·阿莱纳的攀岩者发明了第一版专业登山鞋，至今已为所有登山者使用。枫丹白露的砂岩坚硬平缓，因此您可将其作为基础材料来锻炼自己的技巧、力量和策略。春秋季是该地最佳的练习季节，您将体验到最好的攀登条件，并探索到为何过去的登山者将这个神奇的地方称作“运动的实验室”。</p>
