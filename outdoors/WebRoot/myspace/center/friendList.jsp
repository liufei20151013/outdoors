<%@ page language="java" import="java.util.*,com.wipe.entity.User,com.wipe.biz.UserBiz,com.wipe.dao.UserDao" pageEncoding="UTF-8"%>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/frontdesk/space/friendList.js"></script>
<!-- 
<script src="${pageContext.request.contextPath}/article/addArticleImage/js/jquery.min.js"></script>
 -->
<style type="text/css">
...
<script type="text/javascript">
    ...
    function gotopage(currentpage){
    	location = "${pageContext.request.contextPath}/space.do?method=friendList&currentpage=" + currentpage+"&customerId=${customerId}";
...
<body>
  <%
	...
	%>
	<input id="addFriend" type="hidden" value="PersonalCenterServlet?method=addFriend">

   <div class="friendExposeFriendBox">
       <div class="firstFriend">TA的驴友</div>
