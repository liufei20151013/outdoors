...
$(document).ready(function(e) {
 ...
 <body>
  ...
  <div class="con">
    ...
    <h1 >香格里拉（成都----香格里拉 ）</h1>
    <p >&nbsp;</p>
          <h1 ><img src="images/qx4.jpg" width="600" height="360"></h1>
          <p >&nbsp;</p>
          <p >          线路：成都市→都江堰市→小金县→丹巴县→新都桥镇→理塘县→稻城县→乡城县→香格里拉县→丽江市→泸沽湖镇→盐源县→西昌市→雅安市→成都市(全程1500多公里)</p>
    　　线路特点：美景集结地。高度浓缩川滇两省的精华景致：低海拔冰川海螺沟、情歌的故里康定、摄影天堂新都桥、中国最美的高原古村丹巴、人间最后的净土稻城亚丁、不能用语言形容其美丽的泸沽湖、雄美壮丽的虎跳峡、古朴秀美的丽江古城……另外，选择此线路还能穿越众多少数民族聚居地，尽情领略绚烂多彩的民族风情。该路线以自然风光见长，全线路程漫长，公路大多盘山而筑，道路崎岖。部分路段为土石路面和沙石路面。 
    <p> 最佳骑行时间：9-10月，气温适宜，景色绝佳。9月-次年4月是积雪期，5月、10月下旬至11月中旬景色最美，中间几个月可能会受到雨季的影响。 </p>
    <p>所需天数：20-30天。 </p>
<p>骑行准备：长途骑行(尤其是爬坡)的速度，并不取决于体能和体力，而是取决于所驮物品的重量。此线路爬坡的地方太多，所以尽量少带东西。高原的紫外线很强烈，要注意防晒。 </p>
 </p>
  </div>
