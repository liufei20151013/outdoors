...
<style tydive="text/css">
   *{margin:0;padding:0;font-family="微软雅黑";}
	...
	.loginBegin,.loginBegin1{display:none;position:absolute;left:35%;top:300px;color:white; line-height:200%;width:400px;height:200px;border:2px solid #aaa;background:#383838;}
  ...
  .photo_box01{width:1050px;height:370px;float:right;position:relative;}
   ...
   .btn .current{background-image:url(images/ctrl_01.png);} 
    .bmn{width:50px;line-height:50px;margin:0 25px;float:left;cursor:pointer;}
  .bmn1{width:50px;line-height:50px;margin:0 25px;float:left;cursor:pointer;}
  .bmn2{width:50px;line-height:50px;margin:0 25px;float:left;cursor:pointer;}
  .bm{width:300px;height;50px;display:none;position:absolute;left:40%;top:800px;color:white;border:2px solid #aaa;background:#383838;}  
  .bm1{width:300px;height;50px;display:none;position:absolute;left:40%;top:1550px;color:white;border:2px solid #aaa;background:#383838;}
	</style>
       ...
       <div class="box">
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/1.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	</div>
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/2.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/3.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/4.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/5.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao1"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	</div>
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/6.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao1"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/7.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao1"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
       	...
       	<div class="rot">
       		 ...
       		 <div class="cap">
       		 	...
       		 	<div class="im">
       		 		<a href="walk/8.jsp"><img src="images/jie.png"/></a>
       		 		<div class="bao1"><a href="walklist.jsp"><img src="images/bao.png"/></a></div>
       		 		</div>
       		 	</div>
       		</div>       	
