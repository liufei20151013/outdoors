...
<!--
	...
	-->
<link rel="stylesheet" href="css/mymessage.css" type="text/css" />
...
<body>
	...
	<div class="top">
		...
		<div id="list2">
			<a href="main.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;首页</a><span>&nbsp;|&nbsp;</span>
	...
	<div class="center">
			...
			<div class="leftNavigationBottom">
				...
				<div class="personalInfomation">
					...
					<table class="ab">
						...
						<tr>
							<td><a href="ArticleServlet?method=inArticle">发表足迹</a></td>
						</tr>
						<tr>
						</tr>
					</table>
		...
		<div class="right">
			<div id="title">
				<img id="png" src="images/customer/shangbiao.png" />基本信息
			</div>
			<hr />
			<div class="ac">
				<form id="fm1" method="post" action="UserMessageServlet">
					<ul>
					<li><div id="af">
