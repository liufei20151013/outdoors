...
<body>
  ...
  <div class="con">
    <h1 >&nbsp;</h1>
    <h1 >英国康沃尔West Penwith</h1>
    <p >&nbsp;</p>
          <h1 ><img src="images/py7.jpg" width="600" height="394"></h1>
          <p >&nbsp;</p>
          <p >           West Penwith海岸沿线的花岗石峭壁为英国西南端筑起了一道金色边缘。对于任何一个热爱圣艾夫斯、鱼和薯条的人，这里都是全英国最具吸引力和最浪漫的攀岩区。位于兰兹角南部的森嫩拥有极佳的较低级别传统单线攀登路线，从那里向大西洋延伸出一个非潮汐平台，就像航空母舰的甲板。若是在海浪汹涌时攀登，一定要注意安全。</p>
